...
!(function() {
	...
	chplayer.prototype = {
		...
		*/
		...
		contextMenu: [
			['魔法编程', 'link', 'http://www.xthinking.net'],
			['v1.0', 'default'],
		...
		*/
		...
		interFace: function() {
			...
			*/
			...
			html += '<div id="myFullPage" style="display: none"></div>';
			...
			//构建进度条内容结束
			this.getByElement(pauseCenterID).innerHTML = this.newCanvas(pauseCenterID, 60, 60); //构建中间暂停按钮
			...
			var cPauseCenterFillRect = function() {
				...
				cPauseCenter.arc(30, 30, 26, 0, 2 * Math.PI, false); //用于绘制圆弧context.arc(x坐标，y坐标，半径，起始角度，终止角度，顺时针/逆时针)
			...
			var cPauseCenterOver = function() {
				cPauseCenter.clearRect(0, 0, 60, 60);
